 ...
 * @author Alvanditya
 */
public class HomePage2 implements Initializable {
    ...
    private void btnAboutUs(ActionEvent event) {
        ...
        h.pindahAction(event, "vaboutUs2.fxml");
    }
    ...
    private void btnBencanaAlam(ActionEvent event) {
        ModelHalaman h = new ModelHalaman();
        h.pindahAction(event, "vBencanaAlam2.fxml");
    }
    
    @FXML
    private void btnMedis(ActionEvent event) {
        ModelHalaman h = new ModelHalaman();
        h.pindahAction(event, "vHalamanMedis2.fxml");
    }
    ...
    private void btnZakat(ActionEvent event) {
        ModelHalaman h = new ModelHalaman();
        h.pindahAction(event, "vZakat2.fxml");
    }
    ...
    private void btnSetting(ActionEvent event) {
        ModelHalaman h = new ModelHalaman();
        h.pindahAction(event, "/accountsetting/Profile.fxml");
    }

    @FXML
    private void btnDBD(MouseEvent event) {
        ModelHalaman h = new ModelHalaman();
        h.pindahMouse(event, "/Deskripsi_Pembayaran/vDonasiPenyakit.fxml");
    }

    @FXML
    private void btnBanjir(MouseEvent event) {
        ModelHalaman h = new ModelHalaman();
        h.pindahMouse(event, "/Deskripsi_Pembayaran/vDonasiAlam.fxml");
    }
